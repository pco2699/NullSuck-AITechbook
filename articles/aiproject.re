...
#@# 大量なデータ → 大量のデータ (のほうが読みやすい)
そのために、データを保管できる十分なデータベースを準備する必要があります。
#@# 必要が → 必要も （のほうが脳に入ってきやすい）
...
#@# 図待ち
#@#
#@# 以降、各ステップを解説していきます。的なのが欲しい。
#@#

=== 目的設定
どんなAIを作りたいのか？つまり、どんなモデルを構築するのかを明確にします。
#@# まず目的設定ですが、みたいなワンクッションが欲しい。
#@# まず目的設定ですが、どんなAIを作りたいのか？つまり、どんなモデルを構築するのかを明確にします。
