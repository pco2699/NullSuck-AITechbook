...
== スコアリングの活用方法
#@# スコアリングの活用方法は大きく４つあります、的なワンクッションが欲しい
==== 定量的理解
...
#@# つまり、が始まり方として唐突。
#@# これから一緒に作っていくスコアリングモデルは、ユーザーの行動を採点するアルゴリズムになります。
...
#@# 意味が分かりにくい（接続詞がよくわからない）
統計にもいろいろな種類があります。何かの目的に対してそれを説明する要素が複数あったときに、
その説明変数の重要度をそれぞれ明らかにするのは@<kw>{説明的であり、統計モデル}と言えます。
...
#@# 点の位置が読みづらい
#@# 人間にわかりやすく理解してもらうためには統計的アプローチが必要にもかかわらず、
#@# AIとして実装するにあたっては機械に理解してもらうために仕組み化してデプロイする必要があります。
